		...
		<div id="list-course" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="startTime" title="${message(code: 'course.startTime.label', default: 'Start Time')}" />
					
						<g:sortableColumn property="endTime" title="${message(code: 'course.endTime.label', default: 'End Time')}" />
				...
				<g:each in="${courseInstanceList}" status="i" var="courseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${courseInstance.id}">${fieldValue(bean: courseInstance, field: "startTime")}</g:link></td>
